...
func TestParseErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{"exec with empty command at l2", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{exec: \"\"}]}}}]\n", "exec requires a command"},
		{"file_count without glob", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count: {expect: \"> 50\"}}]}}}]\n", "file_count requires a glob"},
		{"file_count without expect", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count: {glob: \"*.jpg\"}}]}}}]\n", "file_count requires an expect"},
		{"file_count bad glob", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count: {glob: \"photos/[\", expect: \"> 1\"}}]}}}]\n", "not a valid pattern"},
		{"file_count at l3", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: dumpdir, path: /p, pattern: \"*.gz\"}]\ndrills: [{name: d, source: s, schedule: x, levels: {l3: {sandbox: {image: p}, checks: [{file_count: {glob: \"*.jpg\", expect: \"> 1\"}}]}}}]\n", "not valid at L3"},
		{"file_count unknown key", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count: {glob: \"*.jpg\", expect: \"> 1\", mood: strict}}]}}}]\n", "unknown key"},
		{"mount mode on dumpdir", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: dumpdir, path: /p, pattern: \"*.gz\"}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {mode: mount}, checks: [{path_exists: a}]}}}]\n", "mount is not valid for a dumpdir source"},
		{"mount mode with sample", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {mode: mount, sample: {files: 5}}, checks: [{path_exists: a}]}}}]\n", "sampling applies to copy restores"},
		{"mount mode with sample scope", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {mode: mount, scope: sample}, checks: [{path_exists: a}]}}}]\n", "not valid with mode: mount"},
		{"mount mode with hash_match", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {mode: mount}, checks: [{hash_match: true}]}}}]\n", "nothing is engine-verified"},
		{"bad restore mode", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {mode: nfs}, checks: [{path_exists: a}]}}}]\n", "must be copy or mount"},
		{"tcp at l2", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{tcp: 5432}]}}}]\n", "not valid at L2"},
		{"tcp port zero", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: dumpdir, path: /p, pattern: \"*.gz\"}]\ndrills: [{name: d, source: s, schedule: x, levels: {l3: {sandbox: {image: p}, checks: [{tcp: 0}]}}}]\n", "port in 1..65535"},
		{"tcp port out of range", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: dumpdir, path: /p, pattern: \"*.gz\"}]\ndrills: [{name: d, source: s, schedule: x, levels: {l3: {sandbox: {image: p}, checks: [{tcp: 70000}]}}}]\n", "port in 1..65535"},
		{"negative sample files", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {sample: {files: -5}}, checks: [{path_exists: a}]}}}]\n", "sample.files: must be >= 0"},
		{"negative sample newest", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {sample: {newest: -1}}, checks: [{path_exists: a}]}}}]\n", "sample.newest: must be >= 0"},
		{"tolerance out of range", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count_tolerance_pct: 150}]}}}]\n", "must be 0..100"},
		{"negative tolerance", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l2: {restore: {scope: full}, checks: [{file_count_tolerance_pct: -3}]}}}]\n", "must be 0..100"},
		{"both passphrase refs", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r, passphrase_file: /f, passphrase_env: E}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {native_check: true}}}]\n", "not both"},
		{"both password refs", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: restic, repo: r, password_file: /f, password_env: E}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {native_check: true}}}]\n", "not both"},
		{"absurd size overflows", "version: 1\ndata_dir: /v\nscratch: {dir: /s, max_bytes: 99999999999999PiB}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {native_check: true}}}]\n", "too large"},
		{"read_data_subset on borg", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: borg, repo: r}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {native_check: true, read_data_subset_pct: 10}}}]\n", "restic only"},
		{"read_data_subset out of range", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: restic, repo: r, password_env: PW}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {native_check: true, read_data_subset_pct: 0}}}]\n", "must be 1..100"},
		{"read_data_subset without native_check", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: restic, repo: r, password_env: PW}]\ndrills: [{name: d, source: s, schedule: x, levels: {l1: {snapshot_max_age: 36h, read_data_subset_pct: 10}}}]\n", "requires native_check"},
		{"exec with empty command at l3", "version: 1\ndata_dir: /v\nscratch: {dir: /s}\nsources: [{name: s, type: dumpdir, path: /p, pattern: \"*.gz\"}]\ndrills: [{name: d, source: s, schedule: x, levels: {l3: {sandbox: {image: p}, checks: [{exec: \"\"}]}}}]\n", "exec requires a command"},
